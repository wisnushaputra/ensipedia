...
<div class="row justify-content-center">
    ...
    <form action="/register" method="post">
      ...
      <div class="form-floating">
        <input type="email" class="form-control @error('email') is-invalid @enderror"  name="email" id="email" placeholder="email@example.com" required value="{{ old('email') }}">
      ...
      <button class="w-100 btn btn-lg btn-primary mt-3" type="submit">Register</button>
        ...
        <small class="d-block text-center mt-3">Already Registered ? <a class="text-primary" href="/login">Login </a></small>
    </main>
    </div>
</div>
