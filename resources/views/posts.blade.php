...
@section('container')
        ...
        <div class="col-md-8">
            <form action="/posts">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn text-white" type="submit" style="background-color: #3FA796">search</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card mb-3">
            ...
            <div style="max-height: 400px; overflow:hidden">
                <img src="{{ asset($posts[0]->image) }}" alt="{{ $posts[0]->category->name }}" class="img-fluid">   
            </div>
            @else
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="position-absolute px-3 py-2" style="background-color:rgba(0, 0, 0, 0.7)">
                        <a class="text-white" href="/posts?category={{ $post->category->slug }}">{{ $post->category->name }}</a>
                    </div>
                    @if ($post->image)
                    ...
                    <div class="card-body">
                      ...
                      <small>By : <a href="/posts?author={{ $post->author->username }}">{{ $post->author->name }}</a>
